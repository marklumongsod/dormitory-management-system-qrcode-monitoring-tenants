...
<meta charset="utf-8" />
  ...
  <title>DMS Emergency Details</title>
    <!--     Fonts and icons     -->
  ...
  <aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-2 border-radius-md my-3 shadow fixed-start ms-4 " id="sidenav-main" style="border: solid #046621;">
    ...
    <hr class="horizontal dark mt-0">
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="guardian.php">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
      ...
      <div class="container-fluid py-1 px-3">
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
          ...
          <div class="card-body custom-color p-3 shadow">
            <div class="row">
              <div class="col-8">
                <h3 class="text-right mb-0" style="text-transform: uppercase; font-size: 20px; color: #046621; padding: 10px;">Student Boarder Guardians</h3>
              </div>
            </div>
          </div>
                    ...
                    <table id="table" class="table bg-white rounded shadow-sm table-striped table-hover shadow" >
                        <thead>
                            <tr>
                                ...
                                <th scope="col">GUARDIAN CONTACT NO.</th>
                         ...
                         while($row = mysqli_fetch_array($result))
                         {
                            ?>
                              <tr>
                                ...
                                <td><?php echo $row['guardianemail']; ?> </td> 
