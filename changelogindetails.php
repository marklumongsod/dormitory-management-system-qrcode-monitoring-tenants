            ...
            <form class="pad" method="post">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                        <label for="select">Old Password</label>
                        <input type="password" class="form-control form-control-sm rounded-3" id="oldpwd" placeholder="Enter password" name="oldpwd" required>
                    </div>
                </div>
                <hr>
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                        <div class="form-group">
                            ...
                            <input type="password" class="form-control form-control-sm rounded-3" id="newpwd" placeholder="Enter password" name="newpwd" required>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                        <label for="select">Confirm Password</label>
                        <input type="password" class="form-control form-control-sm rounded-3" id="confirmpwd" placeholder="Enter password" name="confirmpwd" required>
                    </div>
                </div>
