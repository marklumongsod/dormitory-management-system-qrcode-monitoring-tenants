...
$id = $_GET['id'];
$query = "select * from dorm_list where id = '".$id."' ";
...
if (isset($_POST['submit'])) {
  ...
  $query= "UPDATE dorm_list SET name= '".$name."', intended= '".$designated."', status = '".$status."', date_updated = '".$dt."' WHERE id  = '".$id."'";
  $result = mysqli_query($con, $query); 
  $_SESSION['statuss'] = "Dorm Updated Successfully.";
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                  <div class="form-group">
                                    ...
                                    <select type="text" name="designated" id="designated" class="form-control form-control-sm rounded-3" required>
                                      <option><?php echo $intended ?></option>
