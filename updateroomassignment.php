...
if (isset($_POST['submit'])) {
    ...
    $query = "UPDATE room_assignments SET room_id = ?, dormname = ? WHERE student_number  = ? AND academic_year  = ? AND semester  = ? ";
    $stmt = mysqli_prepare($con, $query);
    mysqli_stmt_bind_param($stmt, "issss", $room_id, $dorm_name, $student_name, $academic_year, $semester);
    $result1 = mysqli_stmt_execute($stmt);

    $query1 = "UPDATE tenants SET dorm_name = ?, room = ? WHERE studnum  = ?";
    $stmt = mysqli_prepare($con, $query1);
    mysqli_stmt_bind_param($stmt, "sss", $dorm_name, $room_id, $student_name);
    $result2 = mysqli_stmt_execute($stmt);

    if ($result1 && $result2) { 
      $_SESSION['statuss'] = "Student successfully moved into a new room.";
...
<head>
  ...
  <title>DMS Update Room Assign</title>
<!--     Fonts and icons     -->
      ...
      <div class="card-body custom-color p-3 shadow">
        <div class="row">
          <div class="col-8">
            ...
            Update Student Boarder Dorm/Room</h3>
          </div>
        </div>
      </div>
            ...
            <form class="pad" method="post"> <br>
                              ...
                              <div class="row">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                  <div class="form-group">
                                    ...
                                    <select type="text" name="student_name" id="student_name" class="form-control form-control-sm rounded-3" >
                                    ...
                                    <?php 
                                                ...
                                                ?>
                                                <option value="<?php echo $studnum; ?> " ><?php echo $fname; ?> <?php echo $lname; ?></option> 
                                                <?php
                                                }}
                                                ?>
                                    </select>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                  <div class="form-group">
                                      <label for="dorm_name" class="control-label">Dorm name</label>
                                      <select type="text" name="dorm_name" id="dorm_name" class="form-control form-control-sm rounded-3">
                                          <option value="">Select dorm</option>
                                          <?php
                                          $query = "SELECT DISTINCT dorm_name FROM room_list ORDER BY dorm_name DESC";
                                          $result = $con->query($query);
                                          if ($result->num_rows > 0) {
                                              while ($optionData = $result->fetch_assoc()) {
                                                  $dorm_name = $optionData['dorm_name'];
                                                  ?>
                                                  <option value="<?php echo $dorm_name; ?> "><?php echo $dorm_name; ?></option>
                                                  <?php
                                              }
                                          }
                                          ?>
                                ...
                                <script>
                                    // Update room number select options based on selected dorm name
                                    $("#dorm_name").on("change", function () {
                                        var dorm_name = $(this).val();
                                        if (dorm_name != '') {
                                            $.ajax({
                                                type: 'POST',
                                                url: 'get_room_numbers_assignment.php',
                                                data: {dorm_name: dorm_name},
                                ...
                                <div class="form-group">
                                  ...
                                  <select type="text" name="room_id" id="room_id" class="form-control form-control-sm rounded-3" >
                                  <option value="">Select room</option>
                                  </?php 
                                                ...
                                                if($result->num_rows> 0){
                                                    while($optionData=$result->fetch_assoc()){
                                                    $room_number =$optionData['room_number'];
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div class="form-group">
                      <label for="semester" class="control-label">Academic Year</label>
                      <select type="text" name="academic_year" id="academic_year" class="form-control form-control-sm rounded-3">
                  ...
                  <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div class="form-group">
                      ...
                      <select type="text" name="semester" id="semester" class="form-control form-control-sm rounded-3">
