...
if (isset($_POST['submit'])) {
    ...
    if (mysqli_num_rows($res_u) > 0) {
        $_SESSION['statuss'] = "Error! Administrator already exists!";
        $_SESSION['status_code'] = "error";
     
    } else {
        mysqli_query($con, "INSERT INTO user (username, password, fullname, role, email, contact_number, date_created) VALUES ('$username', '$password', '$name', '$role', '$email', '$contact', '$dt')");
        $_SESSION['statuss'] = "Administrator Added Successfully.";
                              ...
                              <div class="row">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                  <div class="form-group">
                                    ...
                                    <input type="text" name="username" id="username" class="form-control form-control-sm rounded-3" required/>
                                  </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                  <div class="form-group">
                                    ...
                                    <select type="text" name="role" id="role" class="form-control form-control-sm rounded-3" readonly>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                  <div class="form-group">
                                    ...
                                    <input type="text" name="email" id="email" class="form-control form-control-sm rounded-3" required/>
                                  </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                  <div class="form-group">
                                    ...
                                    <input type="number" name="contact" id="contact" class="form-control form-control-sm rounded-3" required/>
                                  </div>
                                </div>
