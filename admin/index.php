...
?>
            ...
            <?php
            $sql = "SELECT COUNT(*) FROM user WHERE role = 'Dormitory Manager'";
            $result = mysqli_query($con, $sql);

        
            if ($result) {
        
                $countAdmin = mysqli_fetch_array($result)[0];
            } else {
  ...
  <main class="main-content position-relative border-radius-lg ">
    ...
    <form method="POST" action="">
      <div class="row">
          ...
          <div class="card shadow">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-uppercase font-weight-bold">Total Registered Admin</p>
          ...
          <div class="card shadow">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-uppercase font-weight-bold">Total Registered Students</p>
                    <h5 class="font-weight-bolder">
                    <?php echo $count;?>
                    </h5>
                    <!--<p class="mb-0">
        ...
        <div class="col-xl-6 col-sm-6 mb-xl-0 mb-4"><br>
          <div class="card shadow">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
        ...
        </div> <div class="col-xl-6 col-sm-6 mb-xl-0 mb-4"><br>
          <div class="card shadow">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
      ...
      <br>
      <div class="row">
        <div class="col-xl-12 col-sm-6 mb-xl-0 mb-4"><br>
          <div class="card shadow">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
