...
if (isset($_POST['submit'])) {
  ...
  if ($payment === 'Electricity Fee') {
    ...
    if (mysqli_num_rows($existingResult) > 0) {
      ...
      $_SESSION['statuss'] = "Payment Successfully Added.";
    ...
    if ($currentBalance == 0 && $row['semester'] == $_POST['semester']) {
      $_SESSION['statuss'] = "The student has already fully paid for this semester.";
      $_SESSION['status_code'] = "error";
      mysqli_query($con, "DELETE FROM payment WHERE student_number = '$student_number' AND academic_year = '$academic_year' AND semester = '$semester' AND payment = '$payment' AND date_created = '$dt'");
            ...
            <div class="card-body mt-3 text-dark ">
              ...
              <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                <div class="form-group">
                    ...
                    <input type="number" name="ornumber" id="ornumber" class="form-control form-control-sm rounded-3 ">
                  ...
                  <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div class="form-group">
                      ...
                      <input type="number" name="amount" id="amount" class="form-control form-control-sm rounded-3"
